...
function InitializeThree() {
    ...
    const sunLight = new THREE.DirectionalLight(0x00ff00, 1.3)
    ...
    let sprite = new THREE.TextureLoader().load('../media/img/texture.jpg');



    const material = new THREE.MeshPhongMaterial({ map: sprite })// sides
