var dd = document.getElementById("canvass");
var cv = dd.getContext("2d");
var w = dd.width = document.getElementById('contact').offsetWidth;
var h = dd.height = document.getElementById('contact').offsetHeight + 100
document.getElementById("first").appendChild(dd);
...
function draw() {
    ...
    cv.fillStyle = 'rgba( 31, 32, 33, 1 )';
    cv.strokeStyle = 'rgba( 31, 32, 33, 1 )';
    cv.lineWidth = 2;
    var grid = {
        mesh: [],
        shapeSize: 20,
...
var reset = function () {
    w = dd.width = document.getElementById('second').offsetWidth;
    h = dd.height = document.getElementById('contact').offsetHeight + 100
    draw();
}
draw();
